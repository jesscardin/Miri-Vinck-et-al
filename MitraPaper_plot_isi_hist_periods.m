...
%                             for k = 1:5
%                                 if k==1
%                                     A = nanmedian((R.isi_base(sl,:)));
%                                 else
%                                     A = nanmedian(squeeze(R.isi_ictal(sl,:,k-1)));
%                                 end
%                                 tmp(k,:) = A;
%                             end                                
%                             figure, plot(smooth(tmp(2,:),5),'k'), hold on, plot(smooth(tmp(5,:),5),'g')
%                             keyboard
%                                 plot(nanmedian(R.isi_base(sl,:)))
%                             hold on
%                             plot(nanmedian(squeeze(R.isi_ictal(sl,:,4))),'r')
                            
                            %figure, plot(nanmean(R.isi_base(sl,:)))
